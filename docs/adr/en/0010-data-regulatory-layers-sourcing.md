...
The CAA [RPA management system](https://drone.caa.gov.tw/) (hereafter the "CAA interactive map") itself offers **only an interactive query, with no API or file download**; but request [#136966](https://data.gov.tw/suggests/136966) ("release no-fly/restricted zones as SHP/KMZ") was **closed as released in 2025-06**, and the CAA has published several layers as open data:
